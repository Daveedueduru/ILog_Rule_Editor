      ...
      <form @submit.prevent="handleSubmit">
        <div class="row">
          <div class="col-4">
            <div class="input-group mb-3">
              ...
              <input class="form-control" type="text" placeholder="Device" :readonly="true" />
            </div>
          </div>
        </div>
        ...
        <div class="row" v-for="(temp, index) in tempAttrList" v-bind:key="index">
          <div class="col-4">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <label class="input-group-text" id="basic-addon1">{{ temp.attrName }}</label>
              </div>
              <input
                type="text"
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <label class="input-group-text" id="basic-addon1">
                  <input type="checkbox" v-model="selectActiveTime" style="cursor: pointer;" />
                  &nbsp;
                  Active Time &nbsp;
                  <i
                    class="fa fa-clock-o"
